  ...
  if (showSuccess) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative bg-yugi-dark border border-yugi-border rounded-lg p-6 w-full max-w-md mx-4">
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-yugi-dark border border-yugi-border rounded-lg p-6 w-full max-w-md mx-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-medium rounded-lg px-4 py-3 hover:bg-gray-100 transition-colors mb-4"
        >
